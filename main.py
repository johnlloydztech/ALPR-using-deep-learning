...
class Video(object):
    ...
    def load_model(self, model):
        ...
        model = torch.hub.load(r'D:\OCRFINAL\Flask-Web-Framework-main\Tutorial 7\yolov5-master', 'custom', path=r'D:\OCRFINAL\Flask-Web-Framework-main\Tutorial 7\yolov5-master\models\best.pt', source='local')
        return model
